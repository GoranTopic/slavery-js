...
var ServiceDiscoveryService_exports = {};
__export(ServiceDiscoveryService_exports, {
  default: () => ServiceDiscoveryService_default
});
module.exports = __toCommonJS(ServiceDiscoveryService_exports);
var import_service = __toESM(require("../service/index.js"), 1);
const ServiceDiscoveryService = (host, port) => {
  return new import_service.default({
...
//# sourceMappingURL=ServiceDiscoveryService.cjs.map